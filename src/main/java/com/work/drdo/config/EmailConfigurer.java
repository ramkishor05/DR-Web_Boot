...
public class EmailConfigurer {
	...
	public VelocityEngine velocityTemplate() throws VelocityException, IOException {
		...
		// templateProps.put("class.resource.loader.class",
		// "org.apache.velocity.runtime.resource.loader.ClasspathResourceLoader");
		templateProps.put("resource.loader", "file");
		templateProps.put("file.resource.loader.class",
				"org.apache.velocity.runtime.resource.loader.FileResourceLoader");

		templateProps.put("file.resource.loader.path",
				context.getRealPath(File.separator) + "/WEB-INF/templates/email");
		log.info("Email Template path loaded [" + templateProps.getProperty("file.resource.loader.path") + "]");
		System.out
				.println("Email Template path loaded [" + templateProps.getProperty("file.resource.loader.path") + "]");
