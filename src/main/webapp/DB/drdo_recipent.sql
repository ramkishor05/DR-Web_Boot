...
CREATE TABLE `recipent` (
  ...
  CONSTRAINT `rec1` FOREIGN KEY (`address_id`) REFERENCES `address` (`address_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `rec2` FOREIGN KEY (`recipent_for`) REFERENCES `user_diary` (`diary_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
