...
<script src="${path}/assets/bootstrap/js/custom/validatorUserManagement.js"></script>
	<div class="mid-box">
            <div class="register-box clearfix">
                <h2 class="heading-box">Approved Diary Details</h2>
                <div class="inner-container">
               	<div class="col-md-6">
                    ...
                    <c:if test="${diary.diaryType eq 'external'}">
	                    <c:if test="${recipientList.size() ne 0}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-submit">
						<a type="button" role="button" class="btn btn-secondary" href="${path}/admin/diary/getApprovedDiary">Cancel</a>
                    </div>
                </div>                
            </div>
        </div>
