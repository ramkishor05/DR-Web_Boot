...
<div class="mid-box">
	 <div class="register-box clearfix" style="margin-top:50px;">
	                    <div class="block-title">
	                         <h2 class="heading-box">Closed Diary List</h2>
	                    </div>
	                        ...
	                        <table class="table table-border-bottom">
	                            <thead>
	                                <tr>
	                                    ...
	                                    <th class="w10 text-left">Closure Remark</th>
			                            	...
			                            	<c:forEach items="${assign}" var="assignList" varStatus="counter">
				                                <tr>
				                                    ...
				                                    <td>${assignList.diaryType}</td>
				                                     ...
				                                     <td>${assignList.closureComment}</td>
				                                   <%--  <td>
				                                    	<a class="icon edit" href="${path}/admin/diary/viewApprovedDiaryDetails/${assignList.diaryId}/${assignList.assignmentId}">View Details</a>
				                                    </td> --%>
				                                </tr>
			                            	</c:forEach>
	                            		</c:when>
