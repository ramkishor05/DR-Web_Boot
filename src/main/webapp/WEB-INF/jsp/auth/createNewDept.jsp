...
<div class="mid-box">
	<form name='departmentVO' id="departmentVO" action="${path}/admin/saveDept" method='POST'>
                          ...
                          <!--  <div class="row marB30">
                           ...
                           <div class="row marB30">
                             <div class="form-group col-xs-12">
                                 ...
                                 <textarea class="form-control" name="deptDescription" id="deptDescription"></textarea>
                             </div>
                         </div>
                         <div class="row ">
