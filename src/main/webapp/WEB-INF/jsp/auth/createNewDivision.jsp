...
<div class="mid-box">
	<form name='divisionVO' id="divisionVO" action="${path}/admin/saveDivision" method='POST'>
                     ...
                     <div class="block-content padBlock">
                         ...
                         <div class="row marB30">
                         	<div class="form-group col-xs-6">
                                 ...
                                 <input class="form-control" id="divisionName" name="divisionName" type="text">
                             </div>
                           </div>
                          <!--  <div class="row marB30">
                             <div class="form-group col-xs-6">
                           ...
                           <div class="row marB30">
                             <div class="form-group col-xs-12">
                                 ...
                                 <input class="form-control" type="text" name="divisionComment" id="divisionComment">
                             </div>
                         </div>
                         <div class="row ">
