	                    ...
	                    <div id="table-content" class="block-content padBlock">
	                        ...
	                        <table class="table table-border-bottom">
	                            <thead>
	                                <tr>
	                                    <th class="w5">S.No.</th>
	                                    <th class="w15 text-left">Division Name</th>
	                                    <th class="w10 text-left">Division Description</th>
			                            	...
			                            	<c:forEach items="${divisionList}" var="division" varStatus="counter">
						                                <tr>
						                                    ...
						                                    <td>${division.divisionName}</td>
						                                     <td>${division.divisionComment}</td>
						                                    <td>
						                                    	<a class="icon edit" href="${path}/admin/editDivision/${division.divisionId}">Edit</a>
						                                        | <a class="icon delete" href="javascript:showDeleteModal(${division.divisionId});">Delete</a>
						                                    </td>
						                                </tr>
			                            	</c:forEach>
		                            	</c:when>
