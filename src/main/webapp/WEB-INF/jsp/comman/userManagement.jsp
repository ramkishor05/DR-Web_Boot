		...
		<div class="block-content padBlock">
			...
			<div class="form-group" style="margin-top: 15px;">
				<input type="file" name="file" id="picFile"
					class="dz-clickable needsclick" onchange="previewFile()"> <span
					id="fileError" class="help-block error"> </span>
			</div>
		</div>
	</div>
	<div class="form-group col-md-4 col-xs-12">
		<input type="hidden" name="id" value="${userProfile.profileId}" /> <span
			style="color: red">*</span><label class="control-label">Prefix</label>
...
<div class="row">
	...
	<div class="form-group col-md-4 col-xs-12">
		<span style="color: red">*</span><label for="EMAIL_ADDRESS"
			...
			class="form-control" id="EMAIL_ADDRESS" value="${userProfile.email}"
...
<div class="row">
	<div class="form-group col-md-12 col-xs-12">
		...
		<input type="text" name="SHIPPING_ADDRESS"
			value="${userProfile.addressId.addressLine}" id="SHIPPING_ADDRESS"
...
<div class="row">
	<div class="form-group col-md-4 col-xs-12">
		...
		<input type="text" class="form-control"
			value="${userProfile.addressId.addressCity}" id="SHIPPING_CITY"
			name="SHIPPING_CITY">
	</div>
	...
	<div class="col-md-4 form-group">
		<span style="color: red">*</span><label for="SHIPPING_STATE"
			...
			<option value="Andaman and Nicobar Islands"
				<c:if test="${userProfile.addressId.addressState eq 'Andaman and Nicobar Islands'}">selected</c:if>>Andaman
				and Nicobar Islands</option>
			<option value="Andhra Pradesh"
				<c:if test="${userProfile.addressId.addressState eq 'Andhra Pradesh'}">selected</c:if>>Andhra
				Pradesh</option>
			<option value="Arunachal Pradesh"
				<c:if test="${userProfile.addressId.addressState eq 'Arunachal Pradesh'}">selected</c:if>>Arunachal
				Pradesh</option>
			<option value="Assam"
				<c:if test="${userProfile.addressId.addressState eq 'Assam'}">selected</c:if>>Assam</option>
			<option value="Bihar"
				<c:if test="${userProfile.addressId.addressState eq 'Bihar'}">selected</c:if>>Bihar</option>
			<option value="Chandigarh"
				<c:if test="${userProfile.addressId.addressState eq 'Chandigarh'}">selected</c:if>>Chandigarh</option>
			<option value="Chhattisgarh"
				<c:if test="${userProfile.addressId.addressState eq 'Chhattisgarh'}">selected</c:if>>Chhattisgarh</option>
			<option value="Dadra and Nagar Haveli"
				<c:if test="${userProfile.addressId.addressState eq 'Dadra and Nagar Haveli'}">selected</c:if>>Dadra
				and Nagar Haveli</option>
			<option value="Daman and Diu"
				<c:if test="${userProfile.addressId.addressState eq 'Daman and Diu'}">selected</c:if>>Daman
				and Diu</option>
			<option value="Delhi"
				<c:if test="${userProfile.addressId.addressState eq 'Delhi'}">selected</c:if>>Delhi</option>
			<option value="Goa"
				<c:if test="${userProfile.addressId.addressState eq 'Goa'}">selected</c:if>>Goa</option>
			<option value="Gujarat"
				<c:if test="${userProfile.addressId.addressState eq 'Gujarat'}">selected</c:if>>Gujarat</option>
			<option value="Haryana"
				<c:if test="${userProfile.addressId.addressState eq 'Haryana'}">selected</c:if>>Haryana</option>
			<option value="Himachal Pradesh"
				<c:if test="${userProfile.addressId.addressState eq 'Himachal Pradesh'}">selected</c:if>>Himachal
				Pradesh</option>
			<option value="Jammu and Kashmir"
				<c:if test="${userProfile.addressId.addressState eq 'Jammu and Kashmir'}">selected</c:if>>Jammu
				and Kashmir</option>
			<option value="Jharkhand"
				<c:if test="${userProfile.addressId.addressState eq 'Jharkhand'}">selected</c:if>>Jharkhand</option>
			<option value="Karnataka"
				<c:if test="${userProfile.addressId.addressState eq 'Karnataka'}">selected</c:if>>Karnataka</option>
			<option value="Kerala"
				<c:if test="${userProfile.addressId.addressState eq 'Kerala'}">selected</c:if>>Kerala</option>
			<option value="Lakshadweep"
				<c:if test="${userProfile.addressId.addressState eq 'Lakshadweep'}">selected</c:if>>Lakshadweep</option>
			<option value="Madhya Pradesh"
				<c:if test="${userProfile.addressId.addressState eq 'Madhya Pradesh'}">selected</c:if>>Madhya
				Pradesh</option>
			<option value="Maharashtra"
				<c:if test="${userProfile.addressId.addressState eq 'Maharashtra'}">selected</c:if>>Maharashtra</option>
			<option value="Manipur"
				<c:if test="${userProfile.addressId.addressState eq 'Manipur'}">selected</c:if>>Manipur</option>
			<option value="Meghalaya"
				<c:if test="${userProfile.addressId.addressState eq 'Meghalaya'}">selected</c:if>>Meghalaya</option>
			<option value="Mizoram"
				<c:if test="${userProfile.addressId.addressState eq 'Mizoram'}">selected</c:if>>Mizoram</option>
			<option value="Nagaland"
				<c:if test="${userProfile.addressId.addressState eq 'Nagaland'}">selected</c:if>>Nagaland</option>
			<option value="Orissa"
				<c:if test="${userProfile.addressId.addressState eq 'Orissa'}">selected</c:if>>Orissa</option>
			<option value="Pondicherry"
				<c:if test="${userProfile.addressId.addressState eq 'Pondicherry'}">selected</c:if>>Pondicherry</option>
			<option value="Punjab"
				<c:if test="${userProfile.addressId.addressState eq 'Punjab'}">selected</c:if>>Punjab</option>
			<option value="Rajasthan"
				<c:if test="${userProfile.addressId.addressState eq 'Rajasthan'}">selected</c:if>>Rajasthan</option>
			<option value="Sikkim"
				<c:if test="${userProfile.addressId.addressState eq 'Sikkim'}">selected</c:if>>Sikkim</option>
			<option value="Tamil Nadu"
				<c:if test="${userProfile.addressId.addressState eq 'Tamil Nadu'}">selected</c:if>>Tamil
				Nadu</option>
			<option value="Telangana"
				<c:if test="${userProfile.addressId.addressState eq 'Telangana'}">selected</c:if>>Telangana</option>
			<option value="Tripura"
				<c:if test="${userProfile.addressId.addressState eq 'Tripura'}">selected</c:if>>Tripura</option>
			<option value="Uttaranchal"
				<c:if test="${userProfile.addressId.addressState eq 'Uttaranchal'}">selected</c:if>>Uttaranchal</option>
			<option value="Uttar Pradesh"
				<c:if test="${userProfile.addressId.addressState eq 'Uttar Pradesh'}">selected</c:if>>Uttar
				Pradesh</option>
			<option value="West Bengal"
				<c:if test="${userProfile.addressId.addressState eq 'West Bengal'}">selected</c:if>>West
				Bengal</option>
		</select>
	</div>
	...
	<div class="col-md-4 form-group">
		<span style="color: red">*</span><label for="SHIPPING_ZIP"
			...
			class="form-control" value="${userProfile.addressId.addressPin}"
			id="SHIPPING_ZIP" name="SHIPPING_ZIP">
	</div>
	<input type="hidden" name="addressId"
		value="${userProfile.addressId.addressId}" />
</div>
...
<div class="row">
	<div class="form-group col-md-4 col-xs-12">
		<span style="color: red">*</span><label for="PHONE_NUMBER"
			...
			name="PHONE_NUMBER" class="form-control" value="${userProfile.phone}"
			id="PHONE_NUMBER">
	</div>
	<div class="form-group col-md-4 col-xs-12">
...
<div class="row">
	...
	<input type="hidden" value="${userProfile.groupId.groupId}"
		name="groupId">
	<%-- <div class="form-group col-md-4 col-xs-12">
...
<div class="row ">
	...
	<div class="col-md-4 form-group">
		<label for="qualification" class="control-label"><span
			...
			class="form-control" value="${userProfile.basicDetail.qualification}"
...
<div class="row">
	...
	<div class="col-md-4 form-group">
		<label for="researchPaper" class="control-label"><span
			...
			class="form-control" value="${userProfile.basicDetail.researchPaper}"
			id="researchPaper" name="researchPaper">
	</div>
...
<div class="row">
	...
	<div class="col-md-4 form-group">
		<label for="patent" class="control-label"><span
			...
			class="form-control" value="${userProfile.basicDetail.tot}" id="tot"
			name="tot">
	</div>
</div>
<h4>Manpower Details</h4>
<input type="hidden" class="form-control"
	value="${userProfile.manpowerDetail.manpowerId}" id="manpowerId"
	name="manpowerDetail.manpowerId">
<div class="row">

	<div class="col-md-4 form-group">
		<label for="jrf" class="control-label"><span
			style="color: red">*</span>JRF</label> <input type="text"
			class="form-control" value="${userProfile.manpowerDetail.jrf}"
			id="jrf" name="manpowerDetail.jrf">
	</div>

	<div class="col-md-4 form-group">
		<label for="srf" class="control-label"><span
			style="color: red">*</span>SRF</label> <input type="text"
			class="form-control" value="${userProfile.manpowerDetail.srf}"
			id="srf" name="manpowerDetail.srf">
	</div>
	<div class="col-md-4 form-group">
		<label for="mts" class="control-label"><span
			style="color: red">*</span>MTS</label> <input type="text"
			class="form-control" value="${userProfile.manpowerDetail.mts}"
			id="mts" name="manpowerDetail.mts">
	</div>
</div>
<div class="row">
	...
	<div class="col-md-4 form-group">
		...
		<input type="text" class="form-control"
			value="${userProfile.manpowerDetail.ra}" id="ra"
			name="manpowerDetail.ra">
	</div>
	...
	<div class="col-md-4 form-group">
		<label for="projectAssinged" class="control-label"><span
			...
			class="form-control"
			value="${userProfile.manpowerDetail.projectAssinged}"
			id="projectAssinged" name="manpowerDetail.projectAssinged">
	</div>
</div>
<div class="row">
			...
			<c:forEach items="${userProfile.userAwards}" var="userAward"
				...
				<div class="col-md-4 form-group">
					<label class="control-label"> <input
						...
						<input id='Award_${loop.index}_id' name='awards[${loop.index}].id'
						value="${userAward.id}" type="hidden" class="form-control">
					</label>
				</div>
			</c:forEach>
