	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<input name="profileId" value="${profile.profileId}" type="hidden"
				class="form-control"> <input name="address.addressId"
				value="${profile.addressId.addressId}" type="hidden"
				class="form-control"> <input
				name="basicDetail.basicDetailId"
				value="${profile.basicDetail.basicDetailId}" type="hidden"
				class="form-control">
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					<label for="designation" class="control-label"><span
						style="color: red">*</span>Grade</label> <input type="text" id="grade"
			...
			<div class="row">
				<div class="form-group col-md-4 col-xs-12">
					...
					<input type="text" class="form-control" id="SHIPPING_CITY"
						value="${profile.addressId.addressCity}"
			...
			<div class="row">
				<div class="form-group col-md-4">
					<label for="joiningDate" class="control-label"><span
						...
						value="${profile.basicDetail.joiningDate}"
						name="basicDetail.joiningDate" id="joiningDate"
			...
			<div class="row">
				<div class="col-md-4 form-group">
					<label for="qualification" class="control-label"><span
						...
						class="form-control" value="${profile.basicDetail.qualification}"
						id="qualification" name="basicDetail.qualification">
				</div>
				<div class="col-md-4 form-group">
					<label for="researchPaper" class="control-label"><span
						style="color: red">*</span>Research paper</label> <input type="text"
						class="form-control" value="${profile.basicDetail.researchPaper}"
						id="researchPaper" name="basicDetail.researchPaper">
				</div>
				<div class="col-md-4 form-group">
		...
		<div class="modal-footer">
			<input type="hidden" name="${_csrf.parameterName}"
				value="${_csrf.token}" />
			<button type="button" id="welcomeProfileBeanBtn" class="btn btn-primary">Update
				Information</button>
		</div>
	</div>
</div>
<script>
	...
	$(document).ready(function() {
		showModal();
		$('#welcomeProfileBeanBtn').on('click',function(){
   			if($("#welcomeProfileBeanForm").valid()){
   				document.getElementById("welcomeProfileBeanForm").submit();
   			}
		});
	});
</script>
