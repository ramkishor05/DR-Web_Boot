...
<div class="container-fluid">
   ...
   <div class="main">
     ...
     <form:form method="post" action="${path}/cc/resetPasswordSubmit" novalidate="" id="resetPasswordFormSecure" modelAttribute="resetPasswordFormFinal">
                     ...
                     <div class="block-content padBlock">
                         ...
                         <div class="row ">
                             <div class="col-md-12">
                                 ...
                                 <button type="button" id="resetPasswordbtnfinalStep" onclick="validateUpdatePasssword();" class="btn btn-default">Submit</button>
                             </div>
                         </div>
                     </div>
                 </div>
