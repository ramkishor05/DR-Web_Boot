...
<script src="${path}/assets/bootstrap/js/custom/validatorDiary.js"></script>
	<div class="mid-box">
            <div class="register-box clearfix">
               ...
               <form name="assignmentVO" id="recipientVO" method="POST" action="${path}/division/diary/submitFile">
               	<div class="col-md-6">
	 				<div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-submit">
						...
						<a type="button" role="button" class="btn btn-secondary" href="${path}/division/diary/getdiaryList">Cancel</a>
                    </div>
                    </form>
                </div>                
            </div>
