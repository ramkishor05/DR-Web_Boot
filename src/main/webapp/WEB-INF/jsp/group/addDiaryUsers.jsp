...
<div class="mid-box">
	<form name='recipientVO' id="recipientVO" action="${path}/diary/addDiaryUsers" method='POST'>
				...
				<div class="inner-container">
                     ...
                     <div class="user-controls-wrap">
		                ...
		                <div class="user-controls">
		                    <div class="marB30">
	                         ...
	                         <!--  <div class="marB30">
	                         	<div class="form-group col-xs-12">
	                                 ...
	                                 <input class="form-control" id="recipientAddress" name="recipientAddress" type="text">
	                            </div>
	                          </div> -->
	                          <div class="marB30">
	                         	<div class="form-group col-xs-12">
	                                 <label for="recipientContactNo" class="control-label"><span style="color:red">*</span>Contact no.</label>
	                                 <input class="form-control" id="recipientContactNo" name="recipientContactNo" type="text">
	                            </div>
	                          </div>
	                          <div class="marB30">
	                         	<div class="form-group col-xs-12">
	                                 <label for="recipientOfficeNo" class="control-label"><span style="color:red">*</span>Office no.</label>
	                                 <input class="form-control" id="recipientOfficeNo" name="recipientOfficeNo" type="text">
	                            </div>
	                          </div>
	                          <div class="marB30">
                         		<div class="form-group col-xs-12">
                   		...
                   		<div class="row ">
                           	<div class="full-width marT10">
			                	<button type="submit" class="btn btn-primary marR10" id="next2">Next</button>
	...
	$(document).ready(function(){
		...
		$("#addRecipient").on("click",function(){
			var recipientData = {"name": $("#recipientName").val(),"designation": $("#recipientDesignation").val(),
					"officeNumber": ($("#recipientOfficeNo").val()).toString(),"ext" : ($("#recipientExt").val()).toString(),"diaryId" : "${diary.diaryId}"};
			$.ajax({
			     type  :   'POST',
			     ...
			     success  :  function(recipientId){
			    	$.ajax({
					     ...
					     success  :  function(res){
					    	console.log("EEE",res);
					    	$("#tableBody").append("<tr><td>"+res.name+"</td><td>"+res.designation+"</td></tr>")
