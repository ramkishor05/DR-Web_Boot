...
previewFile();  //calls the function named previewFile()
	...
	<div class="mid-box">
           ...
           <p> All required fields are marked with asterisk (<span style="color:red">*</span>)</p>
               <form name="document" id="updateProfileForm" method="POST" enctype="multipart/form-data" action="${path}/scientist/updateInfo" autocomplete="off">
						...
						<div class="form-group col-md-4 col-xs-12">
							...
							<select class="form-control" name="role">
								...
								<c:forEach items="${roles}" var="rol" varStatus="counter">
									<option value="${rol.userRoleId}" <c:if test="${rol.userRoleId eq userProfile.roleId.userRoleId}">selected</c:if>><c:choose>
                       ...
                       var date=new Date();
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-4 form-group">
                                 <label for="researchPaper" class="control-label"><span style="color:red">*</span>Copyright</label>
                                 <input type="text" class="form-control" value="${userProfile.basicDetail.copyright}" id="copyright" name="copyright">
                             </div>
                             
                             <div class="col-md-4 form-group">
                                 <label for="patent" class="control-label"><span style="color:red">*</span>ToT</label>
                                 <input type="text" class="form-control" value="${userProfile.basicDetail.tot}" id="tot" name="tot" >
                             </div>
                         </div>
						...
						<a type="button" role="button" class="btn btn-secondary" href="${path}/scientist/welcomeScientist">Cancel</a>
                    </div>
                    </form>
                </div>                
            </div>
