...
<script src="${path}/assets/bootstrap/js/custom/validatorDiary.js"></script>
	<div class="mid-box">
            <div class="register-box clearfix">
               ...
               <form name="assignmentVO" id="recipientVO" method="POST" action="${path}/deptHead/diary/submitFile">
               	<div class="col-md-6">
	 				<div class="row">
                    ...
                    <c:if test="${diary.diaryType eq 'external'}">
	                    <div class="row marB30">
	                       	<div class="form-group col-xs-12">
	                       		<label for="captcha" class="control-label">Recipient(s)</label>
	           					<ul>
					...
					<div class="row">
                       <div class="form-group col-xs-12">
                            <label class="control-label">Group Head's Remark</label>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-submit">
						...
						<a type="button" role="button" class="btn btn-secondary" href="${path}/deptHead/diary/getdiaryList">Cancel</a>
                    </div>
                    </form>
                </div>                
            </div>
